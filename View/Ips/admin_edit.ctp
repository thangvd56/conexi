<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header text-primary"><?php echo IP_ADDRESS_MENAGEMENT_EDIT ?></h3>
    </div>
    <div class="col-lg-12">
        <ol class="breadcrumb">
    ...
    <div class="col-lg-12">
        <?php echo $this->Form->create('Ip', array('class' => 'form-horizontal')); ?>
        ...
        <div class="form-group">
            <label class="control-label col-sm-2" for="ramarks_update"><?php echo REMARKS ?> :</label>
            <div class="col-sm-8">
                <?php
