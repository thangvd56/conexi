...
<?php foreach ($supports as $key => $value): ?>
    ...
    <div id="support<?php echo $id; ?>" class="panel-body change_style_div display">
        ...
        <div class="col-xs-4 col-sm-4 col-md-4 add_border_right">
        ...
        <div class="col-xs-8 col-sm-8 col-md-8">
            <input type="text" readonly name="detail" class="form-control" id="detail<?php echo $value['Support']['id'] ?>" required="required" value="<?php echo $value['Support']['detail']; ?>" >
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#btn_add_support").unbind('click').click(function () {
            ...
            str += '<div class="col-xs-4 col-sm-4 col-md-4 add_border_right">';
            ...
            str += '<input type="text" name="detail" class="form-control" id="detail" placeholder="100字以内で紹介文を記載" required="required" value="" >';
            str += '</div>';
            str += '</div>';
