            ...
            <div class="col-md-3">
                    <div class="form-group">
                        ...
                        echo $this->Html->link('削除情報',
                            array('controller' => 'customers', 'action' => 'deleted?type=support'),
        ...
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <div class="text-center">
                    <input type="button" value="キャンセル" class="btn btn-success back but_design2 cancel_edit" data-dismiss="modal" style="width: 100px;">
                    <input type="submit" id="btn_confirm_save" value="はい" class="btn btn-success but_design" style="width: 100px;">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <div class="clearfix">&nbsp;</div>
                <div class="text-center">
                    <input type="button" id="btn_cancel_last_notice" value="キャンセル" class="btn btn-success back but_design2" data-dismiss="modal" style="width: 100px;">
                    <input type="submit" id="btn_delete_support" class="btn btn-success  but_design" style="width: 100px;" value="はい">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <div class="text-center">
                    <input type="button" value="キャンセル" class="btn btn-success back but_design2 cancel_edit" data-dismiss="modal" style="width: 100px;">
                    <input type="submit" id="btn_confirm_qa_save" value="はい" class="btn btn-success but_design" &#8203;="" style="width: 100px;">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-body text-center">
                <label id="label_notification_notice">本当によろしいですか？</label>
                <div class="clearfix">&nbsp;</div>
                <input type="checkbox" name="del_physical" value="1" id="del2"><label for="del2">&nbsp;物理的に削除する。</label> <br>
                ...
                <div class="text-center">
                    <input type="button" id="btn_cancel_last_notice" value="キャンセル" class="btn btn-success back but_design2" data-dismiss="modal" style="width: 100px;">
                    <input type="submit" id="btn_delete_question_answer" class="btn btn-success  but_design" style="width: 100px;" value="はい">
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    $(function () {
        ...
        function fetch_support_lists() {
            $.ajax({
                url: "<?php echo Router::url(array('controller' => 'supports', 'action' => 'fetch_support_lists')); ?>",
                dataType: 'html',
                beforeSend: function () {
        ...
        $("body").on("click", "#btn_delete_support", function () {
            ...
            ;
            $.ajax({
                url: "<?php echo Router::url(array('controller' => 'supports', 'action' => 'create')); ?>",
        ...
        function fetch_question_answer_lists() {
            $.ajax({
                url: "<?php echo Router::url(array('controller' => 'supports', 'action' => 'fetch_question_answer_lists')); ?>",
                dataType: 'html',
                beforeSend: function () {
